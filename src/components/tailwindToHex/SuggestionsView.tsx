    ...
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4">
      {suggestions.map((s, index) => (
        <button
          ...
          className="border-border bg-background-secondary hover:bg-border animate-scale-in flex flex-col items-center gap-2 rounded-lg border p-3 opacity-0 transition-all hover:border-pink-500/50"
